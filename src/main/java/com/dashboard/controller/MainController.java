...
public class MainController {/*
	...
	public String registration(@ModelAttribute("userForm") User userForm, BindingResult bindingResult, Model model) {
		...
		logger.debug(userForm.getEmail() +" started registering ");
		//userValidator.validate(userForm, bindingResult);

		if (bindingResult.hasErrors()) {
			logger.debug(userForm.getEmail() +" has some validation errors while registering ");
			return "registration";
		}

		userService.saveUser(userForm);
		logger.debug(userForm.getEmail() +" registration is successful . Autologin started. ");
